...
- AIDM running in production with real users <StatusBadge pillar="aidm" />
- SkemGuard running across six networks <StatusBadge pillar="skemguard" />
- Two films released in national cinemas <StatusBadge pillar="film" />
- Seven contracts deployed on testnet with verified source on the block
  explorer <StatusBadge pillar="contracts" />
