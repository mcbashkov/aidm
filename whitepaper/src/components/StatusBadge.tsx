...
export default function StatusBadge({ pillar, locale }: { pillar: string; locale?: "id" | "en" }) {
  ...
  return <span className={`idm-badge idm-badge--${s.state}`}>{TEKS[s.state][bahasa]}</span>;
}
